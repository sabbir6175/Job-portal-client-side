        ...
        <div>
            ...
            <form onSubmit={handleAddJob} className="card-body">
                ...
                <div className="form-control">
                    ...
                    <select name='jobType' defaultValue="Pick a Job type" className="select select-ghost w-full max-w-xs">
                ...
                <div className="form-control">
                    ...
                    <select name='category' defaultValue="Pick a Job Field" className="select select-ghost w-full max-w-xs">
